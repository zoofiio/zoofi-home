...
export function ProjectsPartners() {
  return (
    <div className="flex flex-wrap items-center justify-center w-full gap-4 md:gap-5">
      {partners.map((item) => (
        <div key={item.name} className="root_anim_item flex flex-1 text-[clamp(60px,6.5vw,100px)] h-[1em] min-w-[2.56em] gap-2 items-center justify-center rounded-[10px] shrink-0 border border-[#3E3E3E]">
