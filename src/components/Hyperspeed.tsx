...
const defaultOptions: HyperspeedOptions = {
  ...
  colors: {
    ...
    leftCars: [0x481e01, 0xcb7435, 0xdc5a00],
    rightCars: [0x014c23, 0x8db9b, 0x328854, 0x84f8b1],
    sticks: 0x83f7b0,
  },
};
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {}, className }) => {
  ...
  return <div id="lights" className={`w-full h-full flex-1 ${className}`} ref={hyperspeed}></div>;
};
